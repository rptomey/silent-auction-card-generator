...
### The Spreadsheet (`auction_items.csv`) {#spreadsheet-config}
...
## Usage
1. Create and/or update the `auction_items.csv` file in the project root folder, using the [required schema](#spreadsheet-config) and details for your auction items.
